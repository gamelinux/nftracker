...
#define NFTRACKERFILELOG               "nftracker.log"
#define MODE_WRITE                     "w"
...
#define UNSET_FILE_START(files) (files->seen &= ~0x01)
#define UNSET_FILE_END(files)   (files->seen &= ~0x01)
...
typedef struct _nft_stats {
    uint32_t got_packets;   /* number of packets received by application */
